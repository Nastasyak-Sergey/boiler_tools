	...
	switch (req->bRequest) {
		...
		case USB_CDC_REQ_GET_LINE_CODING: {
			...
			if ( *len < sizeof(struct usb_cdc_line_coding) ) {
				printf("*** cdcacm_control notsupp line_coding %d, len %d \n", sizeof(struct usb_cdc_line_coding), *len); 
